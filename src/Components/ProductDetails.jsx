...
const ProductDetails = () => {
    ...
    const handleAddCart = ()=>{
        ...
        fetch('https://aesthetica-server-site-9lvrk8db1-md-rafiul-islams-projects.vercel.app/carts', {
            method: 'POST',
            headers: {
        ...
        <div className="card md:flex flex-col card-side bg-base-100 p-4 shadow-xl">
            ...
            <div className="flex-1 card-body">
                ...
                <div className="card-actions justify-end">
                    <button onClick={handleAddCart} className="btn bg-[#ff81c0] w-full">Add to cart</button>
                </div>
            </div>
        </div>
    );
